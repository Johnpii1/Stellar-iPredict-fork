#!/usr/bin/env bash
# =============================================================================
# iPredict — Create seed markets on mainnet after deploy
# =============================================================================
# Usage:
...
#   - ipredict-deployer key must be in stellar keystore
...
echo ""
echo -e "${BOLD}iPredict — Mainnet Market Creation${NC}"
...
echo -e "  https://ipredict-stellar.vercel.app/markets"
